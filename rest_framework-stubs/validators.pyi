...
def qs_exists(queryset: QuerySet[Any]) -> bool: ...
...
class UniqueValidator:
    ...
    lookup: str
    def __init__(self, queryset: QuerySet[Any], message: str | None = ..., lookup: str = ...) -> None: ...
    ...
    def __call__(self, value: Any, serializer_field: Field[Any, Any, Any, Any]) -> NoReturn: ...
...
class UniqueTogetherValidator:
    ...
    queryset: QuerySet[Any]
    fields: Iterable[str]
    def __init__(self, queryset: QuerySet[Any], fields: Iterable[str], message: str | None = ...) -> None: ...
...
class BaseUniqueForValidator:
    ...
    field: str
    date_field: str
    def __init__(self, queryset: QuerySet[Any], field: str, date_field: str, message: str | None = ...) -> None: ...
