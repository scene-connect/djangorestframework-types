...
class TemplateHTMLRenderer(BaseRenderer):
    ...
    def get_template_context(self, data: Any, renderer_context: Mapping[str, Any]) -> Any: ...
...
class HTMLFormRenderer(BaseRenderer):
    ...
    default_style: ClassLookupDict[Any, Any] = ...
    def render_field(self, field: Any, parent_style: Mapping[str, Any]) -> str: ...
...
class _BaseOpenAPIRenderer:
    ...
    def render(self, data: Any, media_type: Any | None = ..., renderer_context: Any | None = ...) -> Any: ...
    def get_schema(self, instance: Any) -> dict[str, Any]: ...
    def get_parameters(self, link: Any) -> dict[str, Any]: ...
    def get_operation(self, link: Any, name: Any, tag: Any) -> dict[str, Any]: ...
    def get_paths(self, document: Any) -> dict[str, Any]: ...
