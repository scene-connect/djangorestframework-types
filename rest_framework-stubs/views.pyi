...
class APIView(View):
    ...
    content_negotiation_class: str | None = ...
    format_kwarg: Any = ...
    headers: Any = ...
    kwargs: Any = ...
    ...
    def permission_denied(self, request: Request, message: str | None = ...) -> NoReturn: ...
    ...
    def options(self, request: Request, *args: Any, **kwargs: Any) -> Any: ...  # type: ignore[override]
